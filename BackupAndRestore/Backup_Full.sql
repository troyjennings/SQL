...
/****** Object:  Job [DatabaseBackup - USER_DATABASES - FULL]    Script Date: 1/7/2019 10:16:27 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 1/7/2019 10:16:27 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [DatabaseBackup - USER_DATABASES - FULL]    Script Date: 1/7/2019 10:16:27 AM ******/
...
@Databases = ''USER_DATABASES, -DSC2Prod_Snapshot'',
@Directory = ''D:\Backups\FULL'',
@BackupType = ''FULL'',
@Verify = ''Y'',
@CleanupTime = 24,
@Compress = ''Y'',
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Daily 9pm', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=1, 
