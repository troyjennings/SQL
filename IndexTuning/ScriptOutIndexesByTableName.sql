...
DECLARE 
  @SchemaName NVARCHAR(255) = N'Securitization', 
  @TableName NVARCHAR(255) = N'DimBusinessType2'
...
WHERE 
  ...
  --AND fg.name = 'DSC_Heavy_FG'-- <> 'FG_Index'
  --AND si.type_desc = 'NONCLUSTERED' AND si.is_primary_key = 0 AND si.is_unique = 0
 
ORDER BY 
stat.user_seeks
,index_name
----si.index_id
--partition_sums.reserved_in_row_GB DESC
    OPTION (RECOMPILE);
GO